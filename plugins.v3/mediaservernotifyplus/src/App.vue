...
const fields = {
  ...
  playback_started: ['season_episode', 'user', 'device', 'ip', 'ip_location', 'progress', 'overview', 'library', 'media_type', 'server', 'time', 'play_link'],
  playback_stopped: ['season_episode', 'user', 'device', 'ip', 'ip_location', 'progress', 'overview', 'library', 'media_type', 'server', 'time', 'play_link'],
  playback_paused: ['season_episode', 'user', 'device', 'ip', 'ip_location', 'progress', 'overview', 'library', 'server', 'time', 'play_link'],
  playback_resumed: ['season_episode', 'user', 'device', 'ip', 'ip_location', 'progress', 'overview', 'library', 'server', 'time', 'play_link'],
...
const labels = { season_episode: '季集', library: '媒体库', category: '分类', file_count: '文件数量', media_type: '媒体类型', rating: '评分', region: '地区', status: '状态', genres: '类型', actors: '演员', overview: '剧情简介', server: '服务器', time: '时间', media_source: '媒体来源', media_id: '媒体 ID', album: '专辑', artist: '歌手', user: '用户', device: '设备', ip: 'IP', ip_location: 'IP 归属地', progress: '播放进度', play_link: '播放链接' }
