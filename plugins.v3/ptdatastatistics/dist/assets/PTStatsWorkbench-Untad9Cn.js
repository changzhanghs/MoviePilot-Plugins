                              ...
                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedRetirementSite.value.route, (level) => {
                                return (_openBlock(), _createElementBlock("details", {
                                  ...
                                  _createElementVNode("summary", null, [
                                    ...
                                    _createElementVNode("span", null, _toDisplayString(level.min_join_days ? `注册 ${durationLabel(level.min_join_days)}` : '注册无限制'), 1),
...
const PTStatsWorkbench = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-bcf0c2fd"]]);
