...
const {resolveComponent:_resolveComponent,createVNode:_createVNode,createElementVNode:_createElementVNode,toDisplayString:_toDisplayString,unref:_unref,openBlock:_openBlock,createBlock:_createBlock,createCommentVNode:_createCommentVNode,normalizeStyle:_normalizeStyle,renderList:_renderList,Fragment:_Fragment,createElementBlock:_createElementBlock,createTextVNode:_createTextVNode,withCtx:_withCtx} = await importShared('vue');


const _hoisted_1 = { class: "pt-dashboard__header" };
const _hoisted_2 = { class: "pt-dashboard__totals" };
const _hoisted_3 = { class: "total-pill" };
const _hoisted_4 = { class: "total-pill total-pill--upload" };
const _hoisted_5 = { class: "total-pill total-pill--download" };
const _hoisted_6 = {
  key: 0,
  class: "pt-dashboard__body"
};
const _hoisted_7 = { class: "donut-wrap" };
const _hoisted_8 = { class: "donut__hole" };
const _hoisted_9 = { class: "site-scroll" };
const _hoisted_10 = { class: "site-row__avatar" };
const _hoisted_11 = { class: "site-row__name" };
const _hoisted_12 = { class: "site-row__metric site-row__metric--upload" };
const _hoisted_13 = { class: "site-row__metric site-row__metric--download" };
const _hoisted_14 = { class: "site-row__share" };
const _hoisted_15 = {
  key: 1,
            ...
            _createElementVNode("div", _hoisted_9, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(sites.value, (site, index) => {
                return (_openBlock(), _createElementBlock("div", {
                  ...
                  _createElementVNode("div", _hoisted_12, "↑ " + _toDisplayString(_unref(formatBytes)(site.daily_upload)), 1),
                  _createElementVNode("div", _hoisted_13, "↓ " + _toDisplayString(_unref(formatBytes)(site.daily_download)), 1),
...
const Dashboard = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-4d87d91b"]]);
