...
const _hoisted_90 = { class: "target-level" };
const _hoisted_91 = { class: "retirement-detail__right" };
const _hoisted_92 = { class: "retirement-detail__metrics" };
const _hoisted_93 = {
  key: 0,
  class: "wealthy-retirement-state",
  "aria-label": "富贵养老状态"
};
const _hoisted_94 = { class: "wealthy-retirement-state__icon" };
const _hoisted_95 = {
  key: 1,
  class: "retirement-route-rail",
  "aria-label": "等级进度"
};
const _hoisted_96 = { class: "retirement-route-rail__line" };
const _hoisted_97 = { class: "retirement-route-rail__nodes" };
const _hoisted_98 = ["aria-pressed", "aria-label", "onClick"];
const _hoisted_99 = {
  class: "retirement-route-node__marker",
  "aria-hidden": "true"
};
const _hoisted_100 = { class: "retirement-route-node__name" };
const _hoisted_101 = { key: 0 };
const _hoisted_102 = { class: "retirement-route-node__badge" };
const _hoisted_103 = {
  key: 2,
  class: "retirement-target-grid"
};
const _hoisted_104 = { class: "requirement-panel" };
const _hoisted_105 = { class: "requirement-panel__heading" };
const _hoisted_106 = {
  key: 0,
...
const _hoisted_110 = { class: "requirement-overview__score" };
const _hoisted_111 = { class: "requirement-table" };
const _hoisted_112 = { class: "requirement-row__item" };
const _hoisted_113 = { class: "requirement-row__progress" };
const _hoisted_114 = {
  key: 1,
...
const _hoisted_116 = { class: "retirement-levels__heading" };
const _hoisted_117 = { class: "retirement-levels__table" };
const _hoisted_118 = ["open"];
const _hoisted_119 = ["onClick"];
const _hoisted_120 = { "data-label": "注册" };
const _hoisted_121 = {
  class: "retirement-level-row__traffic",
  "data-label": "流量"
};
const _hoisted_122 = { "data-label": "分享率" };
const _hoisted_123 = { "data-label": "做种积分" };
const _hoisted_124 = {
  key: 0,
  class: "retirement-level-row__description"
};
const _hoisted_125 = { class: "retirement-level-row__detail-title" };
const _hoisted_126 = {
  key: 1,
  class: "retirement-level-row__alternatives"
};
const _hoisted_127 = { class: "retirement-level-row__detail-title" };
const _hoisted_128 = { class: "retirement-level-row__tasks" };
const _hoisted_129 = {
  key: 4,
  class: "empty-state compact-empty"
};
...
const _hoisted_131 = { class: "section-block settings-layout" };
const _hoisted_132 = { class: "settings-card" };
const _hoisted_133 = { class: "settings-card" };
const _hoisted_134 = { class: "settings-card settings-card--wide" };
const _hoisted_135 = {
  key: 0,
  class: "ptd-settings-grid"
};
const _hoisted_136 = { class: "settings-card settings-card--wide wealthy-site-settings" };
const _hoisted_137 = { class: "section-heading" };
const _hoisted_138 = {
  key: 0,
  class: "wealthy-selection-summary"
};
const _hoisted_139 = { class: "wealthy-selection-summary__sites" };
const _hoisted_140 = {
  key: 0,
  class: "wealthy-selection-avatars",
  "aria-hidden": "true"
};
const _hoisted_141 = { class: "wealthy-selection-summary__copy" };
const _hoisted_142 = {
  key: 1,
  class: "empty-state compact-empty"
};
const _hoisted_143 = { class: "wealthy-picker-toolbar" };
const _hoisted_144 = { class: "wealthy-picker-status" };
const _hoisted_145 = {
  key: 0,
  class: "wealthy-site-picker"
};
const _hoisted_146 = ["aria-pressed", "onClick"];
const _hoisted_147 = {
  key: 1,
  class: "empty-state compact-empty"
};
const _hoisted_148 = { class: "settings-card settings-card--wide" };
const _hoisted_149 = { class: "section-heading" };
const _hoisted_150 = { class: "rules-upload__actions" };
const _hoisted_151 = {
  key: 0,
  class: "rules-upload"
};
const _hoisted_152 = { key: 0 };
const _hoisted_153 = { class: "settings-card settings-card--wide settings-actions" };
...
function compareSites(left, right, key) {
  ...
  if (key === 'join_at') {
    const leftDate = String(left?.join_at || '').slice(0, 10);
    const rightDate = String(right?.join_at || '').slice(0, 10);
    if (!leftDate) return rightDate ? 1 : compareSiteNames(left, right)
    if (!rightDate) return -1
    return leftDate.localeCompare(rightDate) || compareSiteNames(left, right)
  }
...
function requirementRows(site, level, alternativeIndex = null) {
  ...
  pushNumeric({ key: 'bonus', label: '魔力', icon: 'mdi-lightning-bolt-circle', current: site.bonus, target: level.min_bonus, formatter: value => formatNumber$1(value, 0), strict: level.min_bonus_strict, unavailable: site.bonus === null || site.bonus === undefined });
  pushNumeric({ key: 'seeding', label: '做种数', icon: 'mdi-seed-outline', current: site.seeding, target: level.min_seeding, formatter: value => formatNumber$1(value, 0), strict: level.min_seeding_strict });
  ...
  if (selectedAlternative) {
    const taskFields = [
      ...
      ['min_ratio', '分享率', 'mdi-chart-donut', site.ratio, value => formatNumber$1(value, 2)],
      ['min_bonus', '魔力', 'mdi-lightning-bolt-circle', site.bonus, value => formatNumber$1(value, 0)],
      ['min_seeding_points', '做种积分', 'mdi-star-circle-outline', site.seeding_points, value => formatNumber$1(value, 0)],
      ['min_seeding', '做种数', 'mdi-seed-outline', site.seeding, value => formatNumber$1(value, 0)],
      ['min_seeding_size', '做种体积', 'mdi-database-outline', site.seeding_size, formatBytes],
      ['min_torrent_uploads', '发布数', 'mdi-cloud-upload-outline', site.torrent_uploads, value => formatNumber$1(value, 0)],
      ['min_average_seeding_time_days', '平均做种时间', 'mdi-timer-sand', site.average_seeding_time_days, value => `${formatNumber$1(value, 1)} 天`],
    ];
  ...
  const alternativeRows = (level.alternatives || []).map((option, optionIndex) => {
    const conditions = [
      ...
      ['min_ratio', '分享率', site.ratio, value => formatNumber$1(value, 2)],
      ['min_bonus', '魔力', site.bonus, value => formatNumber$1(value, 0)],
      ['min_seeding_points', '做种积分', site.seeding_points, value => formatNumber$1(value, 0)],
      ['min_seeding', '做种数', site.seeding, value => formatNumber$1(value, 0)],
      ['min_seeding_size', '做种体积', site.seeding_size, formatBytes],
      ['min_torrent_uploads', '发布数', site.torrent_uploads, value => formatNumber$1(value, 0)],
      ['min_average_seeding_time_days', '平均做种时间', site.average_seeding_time_days, value => `${formatNumber$1(value, 1)} 天`],
...
function levelAlternativeRequirements(level) {
  ...
  const fields = [
    ...
    ['min_upload', '上传', formatBytes],
    ['min_download', '下载', formatBytes],
    ['min_ratio', '分享率', value => formatNumber$1(value, 2)],
    ['min_bonus', '魔力', value => formatNumber$1(value, 0)],
    ['min_seeding_points', '做种积分', value => formatNumber$1(value, 0)],
    ['min_seeding', '做种数', value => formatNumber$1(value, 0)],
    ['min_seeding_size', '做种体积', formatBytes],
    ['min_torrent_uploads', '发布数', value => formatNumber$1(value, 0)],
    ['min_average_seeding_time_days', '平均做种时间', value => `${formatNumber$1(value, 1)} 天`],
  ];
  return (level.alternatives || []).map((option, index) => ({
    ...
    requirements: [
      ...
      ...(option.unsupported_requirements || []).map(item => (
        `${item.label || '其他要求'} ${item.target || '需人工确认'}`
      )),
    ],
  }))
}
              ...
              _createElementVNode("div", _hoisted_77, [
                ...
                _createElementVNode("div", _hoisted_78, [
                  ...
                  _createVNode(_component_VChip, {
                    ...
                    default: _withCtx(() => [
                      _createTextVNode("养老中 " + _toDisplayString(ordinaryRetiredCount.value), 1)
                    ]),
                    _: 1
                  }),
                  _createVNode(_component_VChip, {
                    class: "wealthy-summary-chip",
                    "prepend-icon": "mdi-crown",
                    variant: "flat"
                  }, {
                    default: _withCtx(() => [
                      _createTextVNode("富贵养老 " + _toDisplayString(wealthyRetiredCount.value), 1)
                    ]),
                    _: 1
                  })
                ])
              ...
              (selectedRetirementSite.value)
                ? (_openBlock(), _createElementBlock("div", _hoisted_79, [
                    _createElementVNode("aside", _hoisted_80, [
                      ...
                      _createVNode(_component_VSelect, {
                        modelValue: retirementSortKey.value,
                        "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((retirementSortKey).value = $event)),
                        items: retirementSortOptions,
                        label: "排序方式",
                        "prepend-inner-icon": "mdi-sort",
                        density: "compact",
                        variant: "outlined",
                        "hide-details": "",
                        class: "retirement-site-sort"
                      }, null, 8, ["modelValue"]),
                      _createElementVNode("div", _hoisted_82, [
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(sortedRetirementSites.value, (site) => {
                          return (_openBlock(), _createElementBlock("button", {
                            key: retirementSiteKey(site),
                            type: "button",
                            class: _normalizeClass(["retirement-site-option", { 'retirement-site-option--selected': retirementSiteKey(site) === retirementSiteKey(selectedRetirementSite.value), 'retirement-site-option--wealthy': site.status === 'wealthy_retired' }]),
                            ...
                            _createElementVNode("span", _hoisted_84, [
                              ...
                              _createVNode(_component_VProgressLinear, {
                                ...
                                color: site.status === 'wealthy_retired' ? 'warning' : 'primary',
                                "bg-color": "surface-variant",
                                height: "4",
                                rounded: ""
                              }, null, 8, ["model-value", "color"])
                            ]),
                            _createElementVNode("small", null, _toDisplayString(site.status === 'wealthy_retired' ? '富贵养老' : `${nextLevelOverallProgress(site)}%`), 1)
                          ], 10, _hoisted_83))
                        }), 128))
                      ])
                    ]),
                    _createElementVNode("article", _hoisted_86, [
                      _createElementVNode("header", _hoisted_87, [
                        ...
                        _createElementVNode("div", _hoisted_91, [
                          (selectedRetirementSite.value.status === 'wealthy_retired')
                            ? (_openBlock(), _createBlock(_component_VChip, {
                                key: 0,
                                class: "wealthy-retirement-badge",
                                "prepend-icon": "mdi-crown",
                                variant: "flat"
                              }, {
                                ...
                                _createElementVNode("div", _hoisted_97, [
                                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedRetirementView.value.route, (level, index) => {
                                    return (_openBlock(), _createElementBlock("button", {
                                      key: level.name,
                                      type: "button",
                                      class: _normalizeClass(["retirement-route-node", { 'is-reached': level.reached, 'is-current': level.is_current, 'is-next': level.name === selectedRetirementSite.value.next_level, 'is-retirement': level.is_retirement, 'is-selected': level.name === selectedRetirementView.value.displayedLevel?.name }]),
                                      "aria-pressed": level.name === selectedRetirementView.value.displayedLevel?.name,
                                      "aria-label": `查看 ${level.name} 等级进度`,
                                      onClick: $event => {selectedRouteLevelName.value = level.name; springUpgradeTaskIndex.value = 0;}
                                    }, [
                                      _createElementVNode("i", _hoisted_99, _toDisplayString(index + 1), 1),
                                      _createElementVNode("strong", _hoisted_100, [
                                        _createElementVNode("span", null, _toDisplayString(splitLevelName(level).local), 1),
                                        (splitLevelName(level).english)
                                          ? (_openBlock(), _createElementBlock("span", _hoisted_101, _toDisplayString(splitLevelName(level).english), 1))
                                          : _createCommentVNode("", true)
                                      ]),
                                      _createElementVNode("em", _hoisted_102, _toDisplayString(routeNodeStatus(selectedRetirementSite.value, level)), 1)
                                    ], 10, _hoisted_98))
                                  }), 128))
                                ])
                              ], 4)
                      ...
                      (selectedRetirementSite.value.status !== 'wealthy_retired' && selectedRetirementView.value.route.length)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_103, [
                            _createElementVNode("section", _hoisted_104, [
                              _createElementVNode("div", _hoisted_105, [
                                _createElementVNode("div", null, [
                                  ...
                                  _createElementVNode("span", null, _toDisplayString(selectedRetirementView.value.isDefaultLevel ? '下一等级' : '所选等级'), 1),
                                  _createElementVNode("strong", null, _toDisplayString(selectedRetirementView.value.displayedLevel?.name || '已是最高等级'), 1)
                                ]),
                                  ...
                                  ? (_openBlock(), _createElementBlock("div", _hoisted_106, [
                                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedRetirementView.value.upgradeTasks, (task, index) => {
                                        return (_openBlock(), _createElementBlock("button", {
                                          key: task.title,
                                          type: "button",
                                          class: _normalizeClass(["spring-upgrade-task", { 'is-selected': selectedRetirementView.value.selectedTaskIndex === index }]),
                                          role: "tab",
                                          "aria-selected": selectedRetirementView.value.selectedTaskIndex === index,
                                          onClick: $event => (springUpgradeTaskIndex.value = index)
                                        }, [
                                          _createVNode(_component_VIcon, {
                                            icon: task.icon,
                                            size: "18"
                                ...
                                _createVNode(_component_VChip, {
                                  color: selectedRetirementView.value.displayedLevel?.reached ? 'success' : 'warning',
                                  size: "small",
                                  variant: "tonal",
                                  "prepend-icon": selectedRetirementView.value.displayedLevel?.reached ? 'mdi-check-circle-outline' : 'mdi-clock-outline'
                                }, {
                                  default: _withCtx(() => [
                              ...
                              (selectedRetirementView.value.requirements.length)
                                ...
                                : (_openBlock(), _createElementBlock("div", _hoisted_114, _toDisplayString(selectedRetirementView.value.displayedLevel ? '该等级没有要求数据' : '没有后续等级要求'), 1))
                            ])
                          ]))
                        : _createCommentVNode("", true),
                      (selectedRetirementView.value.levels.length)
                        ? (_openBlock(), _createElementBlock("section", _hoisted_115, [
                            ...
                            _createElementVNode("div", _hoisted_117, [
                              ...
                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(selectedRetirementView.value.levels, (level) => {
                                return (_openBlock(), _createElementBlock("details", {
                                  key: level.name,
                                  class: _normalizeClass(["retirement-level-row", { 'has-detail': levelHasDetails(level) }]),
                                  open: levelHasDetails(level) && (level.is_current || level.name === selectedRetirementSite.value.next_level)
                                }, [
                                  _createElementVNode("summary", {
                                    onClick: $event => (!levelHasDetails(level) && $event.preventDefault())
                                  }, [
                                    _createElementVNode("strong", null, _toDisplayString(level.name), 1),
                                    _createElementVNode("span", _hoisted_120, _toDisplayString(level.min_join_days ? `${level.min_join_days_strict ? '>' : '≥'} ${durationLabel(level.min_join_days)}` : '无限制'), 1),
                                    _createElementVNode("span", _hoisted_121, [
                                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(levelTrafficRequirements(level), (item) => {
                                        return (_openBlock(), _createElementBlock("span", { key: item }, _toDisplayString(item), 1))
                                      }), 128))
                                    ]),
                                    _createElementVNode("span", _hoisted_122, _toDisplayString(levelRatioRequirement(level).replace(/^分享率\s*/, '')), 1),
                                    _createElementVNode("span", _hoisted_123, _toDisplayString(levelPointsRequirement(level).replace(/^做种积分\s*/, '')), 1),
                                    (levelHasDetails(level))
                                  ...
                                  (level.description || level.alternatives?.length)
                                    ? (_openBlock(), _createElementBlock("div", {
                                        key: 0,
                                        class: _normalizeClass(["retirement-level-row__detail", { 'has-alternatives': level.description && level.alternatives?.length }])
                                      }, [
                                        (level.description)
                                              ...
                                              _createElementVNode("div", _hoisted_128, [
                                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(levelAlternativeRequirements(level), (task) => {
                                                  return (_openBlock(), _createElementBlock("div", {
                                                    ...
                                                    _createElementVNode("strong", null, _toDisplayString(task.title), 1),
                                                    (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(task.requirements, (requirement) => {
                                                      return (_openBlock(), _createElementBlock("span", { key: requirement }, _toDisplayString(requirement), 1))
                                                    }), 128))
                                                  ]))
                                                }), 128))
                                              ])
                        ...
                        : (_openBlock(), _createElementBlock("div", _hoisted_129, "该站等级规则尚未确定"))
                    ])
                  ]))
                : _createCommentVNode("", true),
                ...
                (settingsDraft.value.ptd_cookiecloud_enabled)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_135, [
                      _createVNode(_component_VTextField, {
                        ...
                        hint: "同机使用 localhost；其它局域网设备请替换为 MoviePilot 主机 IP",
                        "persistent-hint": "",
                        readonly: "",
                        variant: "outlined"
                      }, null, 8, ["model-value"]),
              ...
              _createElementVNode("div", _hoisted_136, [
                _createElementVNode("div", _hoisted_137, [
                  ...
                  _createVNode(_component_VChip, {
                    ...
                    default: _withCtx(() => [
                      _createTextVNode("已选择 " + _toDisplayString(settingsDraft.value.wealthy_retirement_sites?.length || 0), 1)
                    ]),
                    _: 1
                  })
                ]),
                ...
                _createVNode(_component_VDialog, {
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_VCard, { class: "wealthy-picker-dialog-card" }, {
                      default: _withCtx(() => [
                              ...
                              ? (_openBlock(), _createElementBlock("div", _hoisted_145, [
                                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(filteredWealthyRetirementSiteOptions.value, (site) => {
                                    return (_openBlock(), _createElementBlock("button", {
                                      key: wealthyRetirementSiteKey(site),
                                      type: "button",
                                      class: _normalizeClass(["wealthy-site-card", { 'is-selected': isWealthyRetirementSiteSelected(site) }]),
                                      "aria-pressed": isWealthyRetirementSiteSelected(site),
                                      onClick: $event => (toggleWealthyRetirementSite(site))
                                    }, [
                                      _createVNode(_sfc_main$2, {
                                        api: __props.api,
                                        site: site,
                                      ...
                                      _createElementVNode("span", null, [
                                        _createElementVNode("strong", null, _toDisplayString(site.site_name), 1),
                                        _createElementVNode("small", null, "站点 ID " + _toDisplayString(site.site_id), 1)
                                      ]),
                                      _createVNode(_component_VIcon, {
                ...
                (customRuleSites.value.length)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_151, [
                      _createElementVNode("div", null, [
                        ...
                        (rulesUploadName.value)
                          ? (_openBlock(), _createElementBlock("small", _hoisted_152, "文件：" + _toDisplayString(rulesUploadName.value), 1))
                          : _createCommentVNode("", true)
                      ])
                    ]))
                  : _createCommentVNode("", true),
