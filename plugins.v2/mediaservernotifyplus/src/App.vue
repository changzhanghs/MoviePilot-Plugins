...
const fields = {
  ...
  playback_started: ['season_episode', 'user', 'device', 'client', 'ip', 'ip_location', 'progress', 'library', 'media_type', 'year', 'server', 'channel', 'time', 'play_link'],
  playback_stopped: ['season_episode', 'user', 'device', 'client', 'ip', 'ip_location', 'progress', 'library', 'media_type', 'year', 'server', 'channel', 'time', 'play_link'],
  playback_paused: ['season_episode', 'user', 'device', 'client', 'ip', 'ip_location', 'progress', 'library', 'server', 'channel', 'time', 'play_link'],
  playback_resumed: ['season_episode', 'user', 'device', 'client', 'ip', 'ip_location', 'progress', 'library', 'server', 'channel', 'time', 'play_link'],
