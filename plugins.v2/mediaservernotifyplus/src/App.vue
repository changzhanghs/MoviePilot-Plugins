...
const fields = {
  ...
  playback_started: ['season_episode', 'user', 'device', 'client', 'ip', 'progress', 'library', 'media_type', 'year', 'server', 'channel', 'time', 'play_link'],
  playback_stopped: ['season_episode', 'user', 'device', 'client', 'ip', 'progress', 'library', 'media_type', 'year', 'server', 'channel', 'time', 'play_link'],
  playback_paused: ['season_episode', 'user', 'device', 'client', 'ip', 'progress', 'library', 'server', 'channel', 'time', 'play_link'],
  playback_resumed: ['season_episode', 'user', 'device', 'client', 'ip', 'progress', 'library', 'server', 'channel', 'time', 'play_link'],
...
const defaultEnabled = new Set(['season_episode', 'category', 'file_count', 'rating', 'server', 'time', 'overview', 'user', 'device', 'client', 'ip', 'progress'])
const config = ref({
  enabled: true,
  types: Object.keys(actions),
  libraries: ['家庭影音::movies'],
  ...
  fetch_metadata: true, lookup_ip: true, flush_on_stop: false, preview_type: 'library_added', send_test: false,
  ...
  _library_options: [
    { title: '家庭影音 · 电影', value: '家庭影音::movies' },
    { title: '家庭影音 · 电视剧', value: '家庭影音::tv' },
    { title: '客厅 Plex · 动画', value: '客厅 Plex::3' },
  ],
})
