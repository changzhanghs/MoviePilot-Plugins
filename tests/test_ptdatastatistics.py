...
class PackagingTests(unittest.TestCase):
    def test_v3_manifest_matches_source(self):
        ...
        self.assertEqual(list(meta["history"]), ["v1.0.2", "v1.0.1", "v1.0.0"])
        self.assertIn('plugin_version = "1.0.2"', source)
    ...
    def test_workbench_ui_polish_contract(self):
        ...
        self.assertIn('placeholder="留空表示全部站点"', source)
        self.assertGreaterEqual(source.count("historyFilters.value.siteIds = []"), 2)
