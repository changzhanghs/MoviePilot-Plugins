...
class PackagingTests(unittest.TestCase):
    def test_v3_manifest_matches_source(self):
        ...
        self.assertEqual(meta["version"], "1.1.3")
        ...
        self.assertEqual(list(meta["history"]), ["v1.1.3", "v1.1.2", "v1.1.1", "v1.1.0", "v1.0.10", "v1.0.9", "v1.0.8", "v1.0.7", "v1.0.6", "v1.0.5", "v1.0.4", "v1.0.3", "v1.0.2", "v1.0.1", "v1.0.0"])
