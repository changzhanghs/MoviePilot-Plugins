...
class PackagingTests(unittest.TestCase):
    def test_v3_manifest_matches_source(self):
        ...
        self.assertEqual(meta["version"], "1.0.4")
        ...
        self.assertEqual(list(meta["history"]), ["v1.0.4", "v1.0.3", "v1.0.2", "v1.0.1", "v1.0.0"])
        self.assertIn('plugin_version = "1.0.4"', source)
    ...
    def test_workbench_ui_polish_contract(self):
        ...
        self.assertIn('class="history-period-scope"', source)
        self.assertLess(source.index('class="history-period-scope"'), source.index('v-for="period in historyPeriods"'))
        self.assertLess(source.index('class="history-period-strip"'), source.index('class="history-site-sidebar"'))
